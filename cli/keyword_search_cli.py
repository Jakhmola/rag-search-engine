...
def main() -> None:
    ...
    bm25search_parser.add_argument("limit", type=float, nargs='?', default=DEFAULT_SEARCH_LIMIT, help="Search limit")
    ...
    match args.command:
        ...
        case "bm25search":
            bm25_search_results = bm25_search_command(args.query, args.limit)
